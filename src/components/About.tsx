    ...
    return (
        <section className=" p-8 rounded-lg shadow-xl mx-4 md:mx-12 my-8 max-w-4xl leading-relaxed h-screen flex flex-col justify-center items-start ">
            ...
            <p className="text-lg mb-4">
                Hi there! I'm <span className="font-semibold">Shadan Saifi</span>, a web developer with a knack for creating engaging digital experiences using the MERN stack.
            </p>
            <p className="text-lg mb-4">
